                ...
                return (
                  <tr key={id}>
                    ...
                    <td className={classes}>
                      ...
                      >
                        {active ? (
                          <Chip style={{maxWidth: '70px'}} color="teal" value={"Active"} />
                        ) : (
                          <Chip style={{maxWidth: '70px'}} color="red" value={"Banned"} />
                        )}
                      </Typography>
                    </td>
                    <td className={classes}>
                    ...
                    <td className={classes}>
                      {active ? (
                        <Button
                          color="red"
                          onClick={() => handleUpdate(id, { active: false })}
                        >
                          Ban
                        </Button>
                      ) : (
                        <Button
                          color="green"
                          onClick={() => handleUpdate(id, { active: true })}
                        >
                          Un ban
                        </Button>
                      )}
